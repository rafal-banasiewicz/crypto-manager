...
public class ZondaHelper {
    ...
    public static String getParams(ZondaRequest zondaRequest, String nextPageCursor) {
    ...
    public static Request buildRequest(String PUBLIC_KEY, long UNIX_TIME, UUID OPERATION_ID, String API_HASH, String URL) {
    ...
    public static ZondaResponse getZondaResponse(String response) throws JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper.readValue(response, ZondaResponse.class);
    }

    public static double getTotalSpent(ZondaRequest zondaRequest, List<ZondaResponse> zondaResponses) {
